    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
	    ...
	    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
	      <el-form :inline="true" :model="filters">
	        <el-form-item>
	          <el-button type="primary" @click="showAddDialog">上传个人文档</el-button>
	        </el-form-item>
	        <el-form-item>
	          <el-button type="primary" @click="handleSearch">新建文件夹</el-button>
	        </el-form-item>
	        <el-form-item>
	          <el-button type="primary" @click="handleSearch">删除</el-button>
	        </el-form-item>
	        <el-form-item>
	          <el-button type="primary" @click="handleSearch">移动</el-button>
	        </el-form-item>
	        <el-form-item>
      ...
      <el-table :data="accounts" highlight-current-row v-loading="loading" style="width: 100%;" @selection-change="selsChange">
        ...
        <el-table-column prop="name" label="文件大小" width="120" sortable>
        </el-table-column>
        <el-table-column prop="name" label="上传时间" width="120" sortable>
        </el-table-column>
